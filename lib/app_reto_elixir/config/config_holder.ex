defmodule NameProject.Config.ConfigHolder do
  use GenServer
  alias NameProject.Config.AppConfig
  @table_name :name_project_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:name_project, :config_loaders, [])
...
defmodule NameProject.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias NameProject.Config.AppConfig
